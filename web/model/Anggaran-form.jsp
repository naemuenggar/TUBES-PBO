<%@ page import="model.Anggaran" %>
    ...
    <body>
        ...
        <div class="container" style="max-width: 600px;">
            <div class="card">
                <h2 style="margin-top: 0; margin-bottom: 1.5rem;">${anggaran.id == null ? "Tambah" : "Edit"} Anggaran
                </h2>
                <form action="../AnggaranServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="jumlah" value="${anggaran.jumlah}" required>
                    </div>

                    <div style="margin-top: 2rem; display: flex; gap: 1rem;">
                        <input type="submit" value="Simpan" class="btn btn-primary" style="flex: 1;">
                        <a href="../AnggaranServlet" class="btn btn-danger"
